...
const CUR_SET:                string = "\033[{};{}H";
const CUR_UP:                 string = "\033[{}A";
const CUR_DOWN:               string = "\033[{}B";
const CUR_RIGHT:              string = "\033[{}C";
const CUR_LEFT:               string = "\033[{}D";
const CUR_DOWN_BEG:           string = "\033[{}E";
const CUR_UP_BEG:             string = "\033[{}F";
const CUR_COL:                string = "\033[{}G";
...
const FG_ID:                  string = "\033[38;5;{}m";
const BG_ID:                  string = "\033[48;5;{}m";

// True color

const FG_RGB:                 string = "\033[38;2;{};{};{}m";
const BG_RGB:                 string = "\033[48;2;{};{};{}m";
