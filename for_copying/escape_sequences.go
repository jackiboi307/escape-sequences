...
const HOME string = "\x1b[H"
const END string = "\x1b[F"
const PG_UP string = "\x1b[5~"
const PG_DOWN string = "\x1b[6~"
const DELETE string = "\x1b[3~"
const INSERT string = "\x1b[2~"

const CTRL_HOME string = "\x1b[1;5H"
const CTRL_END string = "\x1b[1;5F"
const CTRL_PG_UP string = "\x1b[5;5~"
const CTRL_PG_DOWN string = "\x1b[6;5~"
const CTRL_DELETE string = "\x1b[3;5~"
const CTRL_INSERT string = "\x1b[2;5~"
...
const F1 string = "\x1bOP"
const F2 string = "\x1bOQ"
const F3 string = "\x1bOR"
const F4 string = "\x1bOS"
